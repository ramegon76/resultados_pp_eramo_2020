...
pie(frec6, labels = lbls, col=sample(rainbow(length(lbls))),
...
pie(frec7, labels = lbls, col=sample(rainbow(length(lbls))),
...
pie(frec8, labels = lbls, col=sample(rainbow(length(lbls))),
...
pie(frec9, labels = lbls, col=sample(rainbow(length(lbls))),
