...
Se incluye también el cuestionario para unidades agropecuarias, del cual no se dispone de video de llenado.
...
Como se puede observar, se ha decidido publicar este proyecto en un sitio de desarrollo libre en Github, lo que representa una serie de ventajas para los desarrolladores por la facilidad que esto brinda para compartir tanto resultados como los mismos datos de los que provienen, todo dentro del mismo reporte integrado.
